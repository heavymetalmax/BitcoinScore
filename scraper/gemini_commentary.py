...
def _call_openai(prompt: str, api_key: str) -> Optional[str]:
    ...
    developer_instruction = (
        ...
        "  S2: State the trend continuation probability (high/moderate/low) "
        "    and name the single factor most likely to confirm or invalidate it. "
        "    If a hidden risk is present (CipherB bearish div, ETF/price decoupling, "
        "    adaptive gap >12 pts, yield curve re-steepening), name it here.\n\n"
